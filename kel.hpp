...
namespace kel {
    ...
    struct KelInstance {
        ...
        void initvulkan(VkInstance inst, VkPhysicalDevice phys, VkDevice dev, VkQueue queue, uint32_t queueIdx, VkFormat fmt);
    ...
    namespace input {
        bool button(button::Type b);
        void set(button::Type b, bool down);
        void setCursor(float x, float y);
        bool getCursor(float* x, float* y);
    }
